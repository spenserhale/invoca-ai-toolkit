...
test an API URL simply by logging in to the platform first as a Network Role of â€˜Superâ€™ (full access user) and then pasting the URL into the browser.
...
Previous versions of the API accepted formâ€encoded style parameters in the request and used
...
supported via the 2013â€03â€22 version of the API (please contact
