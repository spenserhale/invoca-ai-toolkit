...
The API follows REST conventions. Perform an HTTPS GET to the URL with the format in which youâ€™d like to receive data. The following response formats are supported, where 33 is the advertiser id.
