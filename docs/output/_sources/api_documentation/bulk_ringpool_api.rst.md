...
Additionally, Bulk API responses return the total server processing (this does not include transit) time for the request in the header under the key â€œprocessing-timeâ€, and is reported in milliseconds.
...
.. code-block:: json

  {
      "errors":
      {
          ...
          "classâ€:â€OnlyBulkNumberAllocationAllowed"
      }
  }
