...
.. list-table::
  ...
  * - email_settings
    ...
    - Each hash has two required fields:
      ...
      ``email_address``: string in RFC 2822 addr-spec format. The userâ€™s email address. Unique for this user.
  ...
  * - role
    ...
    - This userâ€™s role in this organization. (A user may have different roles in different organizations)
