...
The operations on Advertiserâ€Affiliate Relationships are similar to Network, in that the interface is fully idempotent, and the create and update commands will act as â€œcreate or updateâ€.
...
.. list-table::
  ...
  * - status
    ...
    - Status of the advertiser â€ affiliate relationship.
