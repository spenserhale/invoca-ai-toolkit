...
.. list-table::
  ...
  * - pricing
    - string
    - Humanâ€friendly representation of the payin pricing (eg. â€œ$5.07 per callâ€).
  ...
  * - condition
    - string
    - Condition options used to determine the base or bonus payout (eg. â€œduration >= 1 min 30 secâ€).
  ...
  * - pricing
    - string
    - Humanâ€friendly representation of the payout pricing (eg. â€œ$5.07 per callâ€).
