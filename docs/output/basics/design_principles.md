...
# Design Principles[¶](https://developers.invoca.net/en/2019-02-01/basics/design_principles.html#design-principles "Permalink to this heading")
## REST[¶](https://developers.invoca.net/en/2019-02-01/basics/design_principles.html#rest "Permalink to this heading")
All interfaces use   
...
## Status Codes[¶](https://developers.invoca.net/en/2019-02-01/basics/design_principles.html#status-codes "Permalink to this heading")
...
## Security[¶](https://developers.invoca.net/en/2019-02-01/basics/design_principles.html#security "Permalink to this heading")
...
## Using OAuth token to Access Invoca APIs[¶](https://developers.invoca.net/en/2019-02-01/basics/design_principles.html#using-oauth-token-to-access-invoca-apis "Permalink to this heading")
...
## Step by step guide using API token to access APIs[¶](https://developers.invoca.net/en/2019-02-01/basics/design_principles.html#step-by-step-guide-using-api-token-to-access-apis "Permalink to this heading")
...
`https://<vanity>.invoca.net/api/2018-11-01/advertisers.json?oauth_token=YbcFHZ38FNfptfZMB0RZ6dk9dOJCaCfU`
Example using Curl to make an API call with token-based authentication:

```
curl-XPOST-H"Accept: application/json"-H"Content-Type: application/json"'https://\<vanity\>.invoca.net/api/2018-11-01/advertisers/1111.json'-d'{"oauth_token":"YbcFHZ38FNfptfZMB0RZ6dk9dOJCaCfU"}'
...
## Idempotency[¶](https://developers.invoca.net/en/2019-02-01/basics/design_principles.html#idempotency "Permalink to this heading")
...
## Self‐Correction[¶](https://developers.invoca.net/en/2019-02-01/basics/design_principles.html#selfcorrection "Permalink to this heading")
...
## Versioning[¶](https://developers.invoca.net/en/2019-02-01/basics/design_principles.html#versioning "Permalink to this heading")
The API version is given as a date in the path.
## Dedicated Subdomain[¶](https://developers.invoca.net/en/2019-02-01/basics/design_principles.html#dedicated-subdomain "Permalink to this heading")
...
## Request Parameter Format & Response Body Format[¶](https://developers.invoca.net/en/2019-02-01/basics/design_principles.html#request-parameter-format-response-body-format "Permalink to this heading")
Previous versions of the API accepted form‐encoded style parameters in the request and used XML as the output format. As of 2018-11-01, all new feature development has switched to JSON format for both request and response. Previous XML functionality will continue to be supported via the 2013‐03‐22 version of the API (please contact 
