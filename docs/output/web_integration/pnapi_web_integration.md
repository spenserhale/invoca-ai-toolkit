...
# SolutionsJS Web Integration (Deprecated)[¶](https://developers.invoca.net/en/2019-02-01/web_integration/pnapi_web_integration.html#solutionsjs-web-integration-deprecated "Permalink to this heading")
**Notice:** Invoca Tags is the supported way for setting up web integration (which internally uses the InvocaJS library, formerly known as SolutionsJS). View the 
## Installation Instructions (Deprecated)[¶](https://developers.invoca.net/en/2019-02-01/web_integration/pnapi_web_integration.html#installation-instructions-deprecated "Permalink to this heading")
...
_Choose Tools gear and select Web Integration._
## Requirements[¶](https://developers.invoca.net/en/2019-02-01/web_integration/pnapi_web_integration.html#requirements "Permalink to this heading")
...
## Identifying a Campaign[¶](https://developers.invoca.net/en/2019-02-01/web_integration/pnapi_web_integration.html#identifying-a-campaign "Permalink to this heading")
...
## Client Side Parameters[¶](https://developers.invoca.net/en/2019-02-01/web_integration/pnapi_web_integration.html#client-side-parameters "Permalink to this heading")
_Note:_ Any parameter value can be populated with a JavaScript variable.  
| Required parameters:  |  
| --- |  
...
| numberToReplace  | String or Hash  |  Default: null Specify which number(s) to replace. Can accept one or many like so: “888-999-1010, 777-888-9999”. Optionally accepts a hash with the number as a key name, and campaignId as it’s value like so: { “888-999-1010”: ‘campaignIdHere’ }  |  
| Optional parameters:  |  
| --- |  
| autoRun  | Bool  |  Default true determines whether Invoca’s web integration runs when the page loads. If you have a single page application and would like to control when Invoca’s web integration runs, set autoRun to false and call Invoca.PNAPI.run() whenever you are ready. Note: autoRun does not have to be false in order to call Inovca.PNAPI.run().  |  
| destinationAsId  | Bool  |  Default false Strips out any special characters and uses found destination phone number’s digits as campaign ID. **Warning! Requires Invoca campaign with explicit ID for each number.**  |  
| campaignIdOverrideParam  | String  |  Default: null Query string name used to identify Campaign ID  |  
...
| updatePoolParams  | Bool  |  Default: true When false, the integration code will not update poolParams on subsequent page visits.  |  
| requiredParams  | Hash  |  Default: null A hash of key value pairs that represent query string names and values. For example: {name: value} The integration will run if any of these are met. When a requiredParam’s value is *, any passed value will considered true.  |  
| cookieNames  | Array  |  Default: null List of cookie names to automatically capture as RingPool Parameters  |  
| telLinkOnly  | Bool  |  Default: false Used for a “Call Now” button. When true, will only update the tel: link on any numberSelector that is found.  |  
| cookieDays  | Int  |  Default: 1 Number of days for cache TTL.  |  
| onComplete  | Function  |  Default: null Arguments: mapping Name of a function to call when Invoca has finished running. This is called after Invoca has run the default number replacement code and swapped out any numbers that were found. For example: functionName not functionName().  |  
| onCompleteOverride  | Function  |  Default: null Arguments: batchId, mapping Name of a function to call when Invoca has finished running. If defined, Invoca will not replace any phone numbers. This function is responsible for updating phone numbers on the web page as the default number replacement code will not be run. For example: functionName not functionName().  |  
| debugMode  | Boolean  |  Default: false When true, will display debug logs in the developer console.  |  
## Examples[¶](https://developers.invoca.net/en/2019-02-01/web_integration/pnapi_web_integration.html#examples "Permalink to this heading")
### campaignIdOverrideParam[¶](https://developers.invoca.net/en/2019-02-01/web_integration/pnapi_web_integration.html#campaignidoverrideparam "Permalink to this heading")
...
### data-invoca-campaign-id[¶](https://developers.invoca.net/en/2019-02-01/web_integration/pnapi_web_integration.html#data-invoca-campaign-id "Permalink to this heading")
...
### defaultCampaignId[¶](https://developers.invoca.net/en/2019-02-01/web_integration/pnapi_web_integration.html#defaultcampaignid "Permalink to this heading")
...
### poolParams[¶](https://developers.invoca.net/en/2019-02-01/web_integration/pnapi_web_integration.html#poolparams "Permalink to this heading")
...
### requiredParams[¶](https://developers.invoca.net/en/2019-02-01/web_integration/pnapi_web_integration.html#requiredparams "Permalink to this heading")
...
### Invoca.PNAPI.run()[¶](https://developers.invoca.net/en/2019-02-01/web_integration/pnapi_web_integration.html#invoca-pnapi-run "Permalink to this heading")
**React**
...
## Migrating from an older version[¶](https://developers.invoca.net/en/2019-02-01/web_integration/pnapi_web_integration.html#migrating-from-an-older-version "Permalink to this heading")
...
> [More on the Solutions Toolkit](https://developers.invoca.net/en/2019-02-01/web_integration/toolkit_library.html)
