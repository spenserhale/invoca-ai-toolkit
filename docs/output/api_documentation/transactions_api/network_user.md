...
# Network / Brand[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/transactions_api/network_user.html#network-brand "Permalink to this heading")
View the support documentation for 
## URL[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/transactions_api/network_user.html#url "Permalink to this heading")
...
| --- | --- |  
| csv  | Comma-Separated Values, or really Anything-Separated Values (see column_separator= below). Returns an optional header row followed by one row for each transaction, with delimited values for each row. `https://mynetwork.invoca.net/api/2019-02-01/networks/transactions/33.csv`  |  
| xml  | Returns an XML document with an array of Transaction elements. `https://mynetwork.invoca.net/api/2019-02-01/networks/transactions/33.xml`  |  
| json  | Returns a JSON array of transaction objects. `https://mynetwork.invoca.net/api/2019-02-01/networks/transactions/33.json`  |  
## Authentication[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/transactions_api/network_user.html#authentication "Permalink to this heading")
...
## Query Parameters[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/transactions_api/network_user.html#query-parameters "Permalink to this heading")
...
## Response[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/transactions_api/network_user.html#response "Permalink to this heading")
### General Parameters[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/transactions_api/network_user.html#general-parameters "Permalink to this heading")  
...
| custom_data  | Array of Custom Data Values  | JSON and XML formats only. This field is not included in response by default, and must be specified in the “include_columns” parameter. See table below for more information about the structure of this array.  |  
...
### RingPool Parameters[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/transactions_api/network_user.html#ringpool-parameters "Permalink to this heading")  
| Field  | Name in Reports  | Description  |  
| --- | --- | --- |  
...
### AdWords Parameters[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/transactions_api/network_user.html#adwords-parameters "Permalink to this heading")  
| Field  | Name in Reports  | Description  |  
| --- | --- | --- |  
...
### Conversion Reporting Parameters[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/transactions_api/network_user.html#conversion-reporting-parameters "Permalink to this heading")  
| Field  | Name in Reports  | Description  |  
| --- | --- | --- |  
...
### Custom Data & Signal Parameters[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/transactions_api/network_user.html#custom-data-signal-parameters "Permalink to this heading")
...
### Signal Parameters[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/transactions_api/network_user.html#signal-parameters "Permalink to this heading")
...
### Enhanced Caller Profile Parameters[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/transactions_api/network_user.html#enhanced-caller-profile-parameters "Permalink to this heading")  
| Field  | Name in Reports  | Description  |  
| --- | --- | --- |  
...
### Additional Feature Parameters[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/transactions_api/network_user.html#additional-feature-parameters "Permalink to this heading")  
| Field  | Name in Reports  | Description  |  
| --- | --- | --- |  
...
## Examples[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/transactions_api/network_user.html#examples "Permalink to this heading")
...
```
curl-k'https://mynetwork.invoca.net/api/2019-02-01/networks/transactions/33.csv?limit=20&start_after_transaction_id=C624DA2C-CF3367C3&oauth_token=YbcFH'
...
```
curl-k'https://mynetwork.invoca.net/api/2019-02-01/networks/transactions/33.csv?limit=50&include_columns=transaction_id,$invoca_custom_columns&exclude_columns=$invoca_default_columns&from=2015-03-26&to=2015-03-27&oauth_token=YbcFH'
...
```
curl-k'https://mynetwork.invoca.net/api/2019-02-01/networks/transactions/33.csv?limit=50&exclude_columns=calling_phone_number,recording&start_after_transaction_id=C624DA2C-CF3367C3&oauth_token=YbcFH'
...
```
curl-k'https://mynetwork.invoca.net/api/2019-02-01/networks/transactions/33.csv?transaction_type=Signal&from=2015-03-24&to=2015-03-27&oauth_token=YbcFH'
...
```
curl-k'https://mynetwork.invoca.net/api/2019-02-01/networks/transactions/33.csv?transaction_type=PostCallEvent&from=2015-03-24&to=2015-03-27&oauth_token=YbcFH'
...
```
curl-k'https://mynetwork.invoca.net/api/2019-02-01/networks/transactions/33.csv?transaction_type[]=Call&transaction_type[]=Signal&from=2015-03-24&to=2015-03-27&oauth_token=YbcFH'
...
```
curl-k-H'Authorization: YbcFH''https://mynetwork.invoca.net/api/2019-02-01/networks/transactions/33.csv?transaction_type[]=Call&transaction_type[]=Signal&transaction_type[]=PostCallEvent&from=2015-03-24&to=2015-03-27'

```

Endpoint:
`https://invoca.net/api/2019-02-01/networks/transactions/<network_id>.<format>`
