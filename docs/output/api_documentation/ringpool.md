...
# Ringpool[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/ringpool.html#ringpool "Permalink to this heading")
...
## Response Formats[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/ringpool.html#response-formats "Permalink to this heading")
...
`https://<NETWORK>.invoca.net/api/2018-11-01/ring_pools/16/allocate_number.xml?ring_pool_key=<KEY>&pid=5567&sid=adwords`
## Errors[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/ringpool.html#errors "Permalink to this heading")
...
<Message>APIKey'A329F4DC002168'isnotvalidforresource'1'</Message>
</Error>
...
If a system error occurs, an InternalServiceError is returned in XML (or simple text for json or csv) with an integer error handle. Contact 
## RingPool Types[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/ringpool.html#ringpool-types "Permalink to this heading")
...
### API Parameters[¶](https://developers.invoca.net/en/2019-02-01/api_documentation/ringpool.html#api-parameters "Permalink to this heading")
