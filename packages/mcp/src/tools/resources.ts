...
function getClient(): InvocaClient {
...
export function registerResourceTools(server: FastMCP) {
  server.addTool({
    name: "list_resources",
    description: "List Invoca resources with pagination",
    parameters: z.object({
  ...
  server.addTool({
    name: "get_resource",
    description: "Get a Invoca resource by its ID",
    parameters: z.object({
  ...
  server.addTool({
    ...
    description: "Create a new Invoca resource",
    parameters: z.object({
  ...
  server.addTool({
    ...
    description: "Delete a Invoca resource by its ID",
    parameters: z.object({
